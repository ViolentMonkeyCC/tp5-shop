<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/home\view\category\index.html";i:1533694114;}*/ ?>
...
<body>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/">首页</a>
				<?php if(is_array($familysCat) || $familysCat instanceof \think\Collection || $familysCat instanceof \think\Paginator): if( count($familysCat)==0 ) : echo "" ;else: foreach($familysCat as $key=>$familyCat): ?>
				> <a href="<?php echo url('/home/category/index', ['cat_id' => $familyCat['cat_id']]); ?>"><?php echo $familyCat['cat_name']; ?></a>
		...
		<div class="list_left fl mt10">
			<!-- 分类列表 start -->
			<div class="catlist">
				<!--面包屑导航第一个元素的分类名称,既当前分类的顶级分类-->
				<h2><?php echo $familysCat[0]['cat_name']; ?></h2>
				<div class="catlist_wrap">
					<!--循环顶级分类下面的二级分类-->
					<!--不能循环顶级,因为当前分类只有一个最顶级,通过面包屑导航第一个元素既获取到顶级元素的cat_id-->
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<?php foreach($goodsDatas as $goods): ?>
					<li>
						<dl>
							...
							<dd><a href="<?php echo url('/home/goods/detail', ['goods_id' => $goods['goods_id']]); ?>"><?php echo $goods['goods_name'] ;?></a></dt>
