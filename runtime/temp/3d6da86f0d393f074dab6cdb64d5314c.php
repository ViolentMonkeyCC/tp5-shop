<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\role\upd.html";i:1533125832;}*/ ?>
...
<div class="formbody">
    ...
    <form action="" method="post">
        ...
        <ul class="forminfo">
            <li>
                <label>角色名称</label>
                <input name="role_name" placeholder="请输入角色名称" value="<?php echo $role['role_name']; ?>" type="text" class="dfinput" /><i></i>
            </li>
            <li>
                <label>分配权限</label>
