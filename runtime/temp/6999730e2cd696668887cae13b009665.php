<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\auth\upd.html";i:1533042777;}*/ ?>
...
<body>
    ...
    <div class="formbody">
        ...
        <form action="<?php echo url('/admin/auth/upd'); ?>" method="post">
            <input type="hidden" name="auth_id" value="<?php echo $atData['auth_id']; ?>">
            <ul class="forminfo">
                <li>
                    <label>权限名</label>
                    <input name="auth_name" placeholder="请输入权限名" value="<?php echo $atData['auth_name']; ?>" type="text" class="dfinput" />
                </li>
                <li>
                    <label>父级权限</label>
                ...
                <li>
                    <label>控制器名</label>
                    <input name="auth_a" placeholder="请输入控制器名" value="<?php echo $atData['auth_a']; ?>" type="text" class="dfinput" />
                </li>
                <li>
                    <label>方法名</label>
                    <input name="auth_c" placeholder="请输入方法名" value="<?php echo $atData['auth_c']; ?>" type="text" class="dfinput" />
                </li>
            </ul>
			<li>
                    <label>&nbsp;</label>
...
<script>
    $("select[name='pid']").val("<?php echo $atData['pid']; ?>")
