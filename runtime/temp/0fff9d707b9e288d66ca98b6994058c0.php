<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\category\add.html";i:1533203812;}*/ ?>
...
<body>
    ...
    <div class="formbody">
        ...
        <form action="<?php echo url('/admin/category/add'); ?>" method="post">
            <ul class="forminfo">
                <li>
                    <label>分类名称</label>
