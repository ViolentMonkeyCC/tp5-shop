<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/home\view\goods\detail.html";i:1533715316;}*/ ?>
...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/">首页</a>
				<?php foreach( $familysData as $familyData ): ?>
				> <a href="<?php echo url('/home/category/index', ['cat_id' => $familyData['cat_id']]);?>"><?php echo $familyData['cat_name'] ;?></a>
				<?php endforeach; ?>
			</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_left fl">
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					...
					<dl>
						<dt><a href=""><img src="/static/upload/<?php echo json_decode($v['goods_middle'])[0];?>" alt="" /></a></dt>
							...
							<li class="product">
								<dl>
									...
									<dd>
										...
										<a <?php echo $k==0?'class="selected"':'' ;?> href="javascript:;"><?php echo $attr['attr_value']; ?> <input type="radio" name="color" value="<?php echo $attr['attr_value']; ?>" <?php echo $k==0?'checked="checked"':''; ?> /></a>
										<?php endforeach;?>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div ">
						<div class="attr mt15">
							<ul>
								<?php foreach($onlyAttrDatas as $onlyAttr): ?>
								<li><span><?php echo $onlyAttr['attr_name'];?>：</span><?php echo $onlyAttr['attr_value']; ?> </li>
								<?php endforeach; ?>
							</ul>
						</div>
