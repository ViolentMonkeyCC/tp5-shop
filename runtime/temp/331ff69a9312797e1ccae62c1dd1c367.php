<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\type\index.html";i:1533196364;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo url('/admin/type/upd', ['type_id' => $type['type_id']]); ?>" class="tablelink">编辑</a> <a href="<?php echo url('/admin/type/del', ['type_id' => $type['type_id']]); ?>" onclick="return confirm('确认删除?')" class="tablelink"> 删除</a></td>
                </tr>
