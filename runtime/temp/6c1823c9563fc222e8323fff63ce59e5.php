<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"H:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\user\add.html";i:1533126741;}*/ ?>
...
<body>
    ...
    <div class="formbody">
        ...
        <form action="<?php echo url('/admin/user/add'); ?>" method="post">
            <ul class="forminfo">
                <li>
                    <label>用户名</label>
